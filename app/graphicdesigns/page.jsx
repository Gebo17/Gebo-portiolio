...
const Page = () => {
  ...
  return (
    ...
    <div className="relative min-h-[80vh] mb-8">
      <FadeUp>
                <h1 className="mt-4 uppercase text-center font-bold">Graphic designs</h1>
            ...
            {posters[2].fields.posters.map((poster) => {
              ...
              return (
                <div
                  ...
                  className="sm:w-[200px] w-[230px] cursor-pointer rounded shadow-black/40 shadow-md relative"
                >
                  {/* Image */}
