...
useEffect(() => {
  ...
  return (
    ...
    <div className="relative mb-8 min-h-[80vh] ">
      <FadeUp>
        <h1 className="mt-4 uppercase text-center font-bold">
          Branding designs
        </h1>
      </FadeUp>
      ...
      <div className="mt-2">
        {posters === null ? (
          <div className="text-red-500 min-h-[80vh] absolute left-1/2 top-[100px] -translate-x-1/2">
            <p className="w-10 h-10 border-4 border-red-500 border-t-transparent rounded-full animate-spin"></p>
          </div>
        ) : (
          <div
            className="w-full px-1 flex flex-wrap items-start justify-center sm:items-center sm:justify-center gap-4 sm:gap-12"
          >
            {posters[1].fields.posters.map((poster) => {
              ...
              return (
                <div
                  ...
                  className="sm:w-[200px] w-[160px] cursor-pointer rounded shadow-black/60 shadow-md relative"
                >
                  {/* Image */}
                  ...
                  {/* Red Overlay */}
                  {isCardHovered && (
                    <div className="absolute sm:w-[200px] w-[160px] inset-0 z-10 bg-red-700/70 transition-all duration-400" />
                  )}
