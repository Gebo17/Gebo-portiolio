...
const AboutMe = () => {
  ...
  return (
    <div className="min-h-[50vh] w-full">
      <div>
        <div
          className={`mx-auto sm:pr-4 py-2 bg-amber-50 flex flex-wrap justify-center items-center gap-2 capitalize w-full`}
        >
          {ABOUT_LINKS.map((navlink, index) => (
            ...
            >
              <p
                onClick={() => setAboutTab(navlink.text)}
                className={`${
                  aboutTab === navlink.text ||
                  (aboutTab === "default" && navlink.text === "Who am i")
      ...
      {(aboutTab === "Who am i" || aboutTab === "default") && <WhoIAm />}
