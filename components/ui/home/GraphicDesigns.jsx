...
const GraphicDesigns = () => {
  ...
  useEffect(() => {
    ...
    let direction = 1; // 1 → right, -1 → left
    const speed = 1.6; // px per frame; tweak to taste
    let hovered = false;
    let rafId = 0;
      ...
      <div className="mt-4 md:mt-8">
        {posters === null ? (
          ...
          <div>
            <div
            ref={scrollRef1}
            className="overflow-x-scroll hide-scrollbar mx-auto w-[80vw] mb-4 flex items-start gap-4 sm:gap-12"
          >
       ...
       <Link href="/graphicdesigns" className="block mx-auto mt-4 text-red-800 capitalize text-center transition-all duration-300">
          view more
        </Link>
    </div>
  );
