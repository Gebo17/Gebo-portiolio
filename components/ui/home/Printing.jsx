    ...
    <div className="relative mb-8">
      ...
      <div className="mt-4 md:mt-8">
        {posters === null ? (
          ...
          >
            {posters[3].fields.posters.slice(0,10).map((poster) => {
       ...
       <Link href="/printing" className="block text-center mx-auto mt-4 text-red-800 capitalize transition-all duration-300">
          view more
        </Link>
      {viewerOpen && (
        <div
