...
const Software = () => {
  ...
  return (
    <div className="px-4 pb-8">
      <FadeUp>
        <h1 className="mt-4">
          I am proficient in a wide range of industry standard software tools
          that support high quality visual design, branding, and digital content
          creation
        </h1>
      </FadeUp>
      ...
      >
        {SOFTWARE_ICONS.map((icon, index) => (
          <div
            key={index}
            className="cursor-pointer block relative py-2 flex-shrink-0 shadow-lg rounded-md hover:scale-110 transition duration-200"
          >
                ...
                <div>
                  ...
                  <img
                    ...
                    className={`rounded-full block ${
                      icon.name === "figma" || icon.name === "pixellab"
                        ? "w-8 h-8 mb-[12px] mt-1"
                        : "w-12 h-12"
                    }`}
                  />
                </div>
