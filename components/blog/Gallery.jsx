...
const Page = () => {
  ...
  useEffect(() => {
    const getitems = async () => {
      ...
      setPosters(response.items[0].fields.photos);
    };
  ...
  return (
    ...
    <div className="relative min-h-[80vh] mb-8">
      <FadeUp>
              <h1 className="mt-4 uppercase text-center font-bold">photos collection</h1>
      </FadeUp>
      ...
      <div className="mt-4 md:mt-8">
        {posters === null ? (
          ...
          <div
            className="p-4 md:p-8 w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md-gap-2 mt-4"
          >
            {posters.map((poster) => {
              ...
              return (
                <div
                  ...
                  className="cursor-pointer rounded shadow-md shadow-black/40 relative"
                >
                  {/* Image */}
                  <div className="">
                    {imageUrl ? (
                  ...
                  {/* Red Overlay */}
                  {isCardHovered && (
                    <div className="absolute h-full  inset-0 z-10 bg-red-700/70 transition-opacity duration-400" />
                  )}
