...
const FileCard = ({ entry }: { entry: Entry<ResourceSkeleton> }) => {
  ...
  const thumbnail = entry.fields.thumnail as any; // ✅ FIXED
  ...
  return (
    ...
    >
      ...
      <div
        className={`
          absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-center p-4 transition-all duration-300
          opacity-0
