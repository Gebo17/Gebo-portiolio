...
const News = () => {useState
  ...
  return (
    <>
      ...
      <div className="min-h-[60vh] flex flex-col gap-8 justify-center sm:justify-start items-center md:flex-row flex-wrap">
            ...
            <Fade key={index}>
              <div className="max-w-[350px] min-w-[300px] shadow-md rounded-md">
                ...
                <div className="px-2 pb-4">
                  <p className="mt-4 text-primary-dark min-h-[50px]">
                    {" "}
